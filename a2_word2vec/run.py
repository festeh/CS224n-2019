...
import random
import numpy as np
from a2_word2vec.utils.treebank import StanfordSentiment
import matplotlib
...
from a2_word2vec.word2vec import *
from a2_word2vec.sgd import *
...
wordVectors = sgd(
    lambda vec: word2vec_sgd_wrapper(
        skipgram, tokens, vec, dataset, C, neg_sampling_loss_and_gradient
    ),
    wordVectors,
    0.3,
    40000,
